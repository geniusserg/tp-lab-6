...
public:
	SeniorManager(int id, string name, string position, string project, int all_budget, int all_count): Manager(id,name,position,project,all_budget,all_count,10){ this->payment += getHsalary(all_count, all_budget); };
};